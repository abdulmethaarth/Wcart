package affle.com.wcart.appsanddevices.runkeeper;
...
import affle.com.wcart.WcartApplication;
    ...
    public void getAuthorizationCode(final Activity activity, final ConnectAppsAndDevicesFragment ConnectAppsDevicesFragment) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(WcartApplication.getGlobalContext());
