...
import affle.com.wcart.adapters.TutorialPageAdapter;
import affle.com.wcart.ui.fragments.TutorialFragment;
...
public class TutorialActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private List<Fragment> getTutorialFragments() {
        ...
        mTutorialFragmentList.add(TutorialFragment.newInstance(R.drawable.splash_bg1, R.string.txt_tutorial_first, R.string.txt_title_tutorial_first));
        mTutorialFragmentList.add(TutorialFragment.newInstance(R.drawable.splash_bg, R.string.txt_tutorial_second, R.string.txt_title_tutorial_second));
       /* mTutorialFragmentList.add(TutorialFragment.newInstance(R.drawable.tutorial_img3, R.string.txt_tutorial_third, R.string.txt_title_tutorial_third));
