...
import affle.com.wcart.customviews.StartSnapHelper;
...
import affle.com.wcart.models.response.ResProductsCategoryData;
...
import affle.com.wcart.ui.activities.ProductsListActivity;
...
public class HomeAllCatFragment  extends BaseFragment {
    ...
    affle.com.wcart.customviews.CustomTypefaceTextView tvBigRowFirst;
    @BindView(R.id.tv_big_row_second)
    affle.com.wcart.customviews.CustomTypefaceTextView tvBigRowSecond;
    @BindView(R.id.tv_small_first_row_first)
    affle.com.wcart.customviews.CustomTypefaceTextView tvSmallFirstRowFirst;
    @BindView(R.id.tv_small_first_row_second)
    affle.com.wcart.customviews.CustomTypefaceTextView tvSmallFirstRowSecond;
    @BindView(R.id.tv_small_second_row_first)
    affle.com.wcart.customviews.CustomTypefaceTextView tvSmallSecondRowFirst;
    @BindView(R.id.tv_small_second_row_second)
    affle.com.wcart.customviews.CustomTypefaceTextView tvSmallSecondRowSecond;
...
///for trending products
       ...
       // reqTrendingProducts.setFilterType(null);
        ...
        Call<ResGetProductsCategories> ResGetProductsCategoriesCall = client.getProductsCategory(reqTrendingProducts);
...
//    }
    ...
    private void openProductDetailScreen(int pos) {
       ...
       /* } else {
        ...
        intent.putExtra("productName", resTrendingProductsData.get(pos).getProCatName());
    ...
    class TrendingPageAdapter extends RecyclerView.Adapter<HomeAllCatFragment.TrendingPageAdapter.TrendingViewHolder>{
        ...
        public void onBindViewHolder(final HomeAllCatFragment.TrendingPageAdapter.TrendingViewHolder holder, int position) {
            ...
            holder.tv_product_name.setText(data.getProCatName());
