...
import affle.com.wcart.RetrofitClient;
import affle.com.wcart.adapters.FlipperAdapter;
import affle.com.wcart.network.IApiClient;
import affle.com.wcart.network.ProductDetails;
import affle.com.wcart.network.ServiceConstants;
import affle.com.wcart.preference.PreferenceKeys;
import affle.com.wcart.ui.fragments.ChallengesFragment;
import affle.com.wcart.ui.fragments.ConnectAppsAndDevicesFragment;
import affle.com.wcart.ui.fragments.FavouriteFragment;
import affle.com.wcart.ui.fragments.FsStoreFragment;
import affle.com.wcart.ui.fragments.HelpAndSupportFragment;
import affle.com.wcart.ui.fragments.HomeFragment;
import affle.com.wcart.ui.fragments.MyAccountFragment;
import affle.com.wcart.ui.fragments.MyCartFragmentNew;
import affle.com.wcart.ui.fragments.MyWalletFragment;
...
import affle.com.wcart.utils.Banner;
import affle.com.wcart.utils.Banners;
import affle.com.wcart.utils.CameraAndGalleryUtils;
import affle.com.wcart.utils.CustomTypefaceSpanNavigationDrawer;
import affle.com.wcart.utils.Logger;
import affle.com.wcart.utils.PermissionUtils;
...
public class HomeActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener, SharedPreferences.OnSharedPreferenceChangeListener {
	...
	affle.com.wcart.customviews.CustomTypefaceTextView tvToolbarCartCount;
	@BindView(R.id.fab)
	ImageView fab;
	@BindView(R.id.tv_toolbar_favourite_count)
	affle.com.wcart.customviews.CustomTypefaceTextView tvToolbarCount;
	...
	private void getBanners() {
		...
		String page = "1";
		Call<Banners> call = api.getBanners(user,method,key,"",page);
		call.enqueue(new Callback<Banners>() {
			...
			public void onResponse(Call<Banners> call, Response<Banners> response) {
				...
				if(res.errstr.equalsIgnoreCase("Slider image get successfully.")){
